...
audioElement.addEventListener("ended", function () {
  ...
  if (songIndex < songs.length) {
    ...
    // Reset progress bar and play the next song
...
Array.from(document.getElementsByClassName("songItemPlay")).forEach(
  (element) => {
    element.addEventListener("click", (e) => {
      if (e.target.classList == "far songItemPlay fa-play-circle") {
        makeAllPlays();
...
document.getElementById("next").addEventListener("click", () => {
  ...
  makeAllPlays();
  //here i jst stored the element with id songIndex in var mine and changed the classList of that element
  var mine = document.getElementById(`${songIndex}`);

  mine.classList.remove("fa-play-circle");
  mine.classList.add("fa-pause-circle");
